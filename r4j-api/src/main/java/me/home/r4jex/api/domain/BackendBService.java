...
@Service
@Slf4j
public class BackendBService implements BizService {

    private final String SERVICE_NAME = "BackendB";
    private final String CIRCUIT_BREAKER_NAME = SERVICE_NAME +".circuit";
    private final String BULKHEAD_NAME = SERVICE_NAME + ".bulkhead";
    private final String TIMELIMITER_NAME = SERVICE_NAME + ".timelimiter";
    ...
    public String ignoreException() {
        throw new BizException("This exception is ignored by the CircuitBreaker of backend B");
    }
